...
*Pozor: Myslím, že je tam problém se sešíváním pro hledání vázaných
stavů. Berte s velkou rezervou, než to odstraním.* (Podle [MHJ, kap.
9.2.3], [Ba], zobecnění na vázané kanály např. v [Gl kap. 2.7.1,
numerov.coupled_channel.pdf])
