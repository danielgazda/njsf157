...
Poslední úprava: [2025-10-14 Tue]

* Literatura (odkazy na konrétní kapitoly níže)
...
Máločásticové jaderné systémy - prezentace (t2_prezentace.pdf)

* Týden 3

Exotické jaderné systémy - prezentace (t3_prezentace.pdf)
...
- Doma přečíst: kapitoly 2.1 - 2.3 v [Gl] (+ 7-a, 7-b v [Ta])
...
- Doma přečíst: kapitola 2.7.2 v [Gl]
...
- Doma přečíst: kapitola 2.7.1 v [Gl]

* Co se nestihlo - literatura

** (TBA) NN interakce, „pionless EFT“
- https://arxiv.org/abs/nucl-th/9706029
** (TBA) NN interakce, chirální EFT
** Systémy s několika nukleony
- Rozptyl + vázané stavy: Faddeev a Faddeev-Yakubovsky [Gl, kap. 3 a 4]
- Variační metody pro vázané stavy: No-core shell model (NCSM), Stochastic Variational Method (SVM) [NCSM.pdf, Barnea.pdf]
